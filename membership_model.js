(() => {
  ...
  function App() {
    ...
    })), /* @__PURE__ */ React.createElement("tfoot", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#f4f5f7", borderTop: "2px solid #e0e0e0" } }, /* @__PURE__ */ React.createElement("td", { colSpan: 6, style: { padding: "11px 12px", fontSize: 13, fontWeight: 700, color: "#1a1a1a" } }, "Membership Total"), /* @__PURE__ */ React.createElement("td", { style: { padding: "11px 12px", textAlign: "right", fontSize: 15, fontWeight: 700, color: "#1a1a2e" } }, fmt(totals.membershipTotal)))))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", color: "#999", fontWeight: 600 } }, "Adjust Tiers"), /* @__PURE__ */ React.createElement("button", { onClick: addTier, style: { background: "#1a1a2e", color: "#fff", border: "none", borderRadius: 6, padding: "6px 14px", fontSize: 12, fontWeight: 600, cursor: "pointer" } }, "+ Add Tier")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, tiers.map((tier, idx) => /* @__PURE__ */ React.createElement(TierPanel, { key: tier.id, tier, colorIdx: idx, onUpdate: (u) => updateTier(tier.id, u), onRemove: () => removeTier(tier.id), canRemove: tiers.length > 1 })))), activeTab === "budget" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e4e4e4", overflow: "hidden", marginBottom: 20, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" } }, /* @__PURE__ */ React.createElement("div", { style: { overflowX: isMobileTabs ? "auto" : "visible" } }, /* @__PURE__ */ React.createElement("table", { style: { width: "100%", minWidth: isMobileTabs ? 620 : "100%", borderCollapse: "collapse" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#f8f8f8" } }, ["Category", "Items", "Subtotal"].map((h, i) => /* @__PURE__ */ React.createElement("th", { key: h, style: { padding: isMobileTabs ? "8px 10px" : "9px 14px", fontSize: isMobileTabs ? 9 : 10, letterSpacing: 1, textTransform: "uppercase", color: "#999", fontWeight: 600, textAlign: i === 0 ? "left" : "right", borderBottom: "1px solid #eee" } }, h)))), /* @__PURE__ */ React.createElement("tbody", null, budget.map((s) => {
      const sub = s.items.reduce((sum, i) => sum + i.qty * i.unit, 0);
      return /* @__PURE__ */ React.createElement("tr", { key: s.id, style: { borderBottom: "1px solid #f0f0f0" } }, /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 14px", fontSize: isMobileTabs ? 12 : 13, fontWeight: 600, color: s.color } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 7 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 10, height: 10, borderRadius: "50%", background: s.accent, flexShrink: 0 } }), s.label)), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 14px", textAlign: "right", fontSize: isMobileTabs ? 11.5 : 12.5, color: "#888" } }, s.items.length, " item", s.items.length !== 1 ? "s" : ""), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 14px", textAlign: "right", fontSize: isMobileTabs ? 12.5 : 13.5, fontWeight: 700, color: s.accent } }, fmt(sub)));
    })), /* @__PURE__ */ React.createElement("tfoot", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#f4f5f7", borderTop: "2px solid #e0e0e0" } }, /* @__PURE__ */ React.createElement("td", { colSpan: 2, style: { padding: isMobileTabs ? "10px 10px" : "11px 14px", fontSize: isMobileTabs ? 12 : 13, fontWeight: 700, color: "#1a1a1a" } }, "Total Budget"), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "10px 10px" : "11px 14px", textAlign: "right", fontSize: isMobileTabs ? 14 : 15, fontWeight: 700, color: "#c0392b" } }, fmt(totals.budgetTotal))))))), /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 10, border: "1px solid #e4e4e4", padding: "14px 18px", marginBottom: 18, boxShadow: "0 1px 3px rgba(0,0,0,0.05)", display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10.5, color: "#999", textTransform: "uppercase", letterSpacing: 1 } }, "Income \u2212 Budget = Net"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "#555", marginTop: 3 } }, fmt(totals.totalIncome), " \u2212 ", fmt(totals.budgetTotal), " = ", /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 700, color: totals.net >= 0 ? "#2e7d52" : "#c0392b" } }, fmt(totals.net)))), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9.5, color: "#999", textTransform: "uppercase", letterSpacing: 1 } }, "vs Goal"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 17, fontWeight: 700, color: surplus >= 0 ? "#2e7d52" : "#c0392b" } }, surplus >= 0 ? "+" : "\u2212", fmt(Math.abs(surplus))))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", color: "#999", fontWeight: 600 } }, "Budget Categories"), /* @__PURE__ */ React.createElement("button", { onClick: addSection, style: { background: "#c0392b", color: "#fff", border: "none", borderRadius: 6, padding: "6px 14px", fontSize: 12, fontWeight: 600, cursor: "pointer" } }, "+ Add Category")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, budget.map((s) => /* @__PURE__ */ React.createElement(BudgetSection, { key: s.id, section: s, onUpdate: (u) => updateSection(s.id, u), onRemove: () => removeSection(s.id) })))), activeTab === "fundraisers" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 12, border: "1px solid #e4e4e4", overflow: "hidden", marginBottom: 20, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" } }, /* @__PURE__ */ React.createElement("div", { style: { overflowX: isMobileTabs ? "auto" : "visible" } }, /* @__PURE__ */ React.createElement("table", { style: { width: "100%", minWidth: isMobileTabs ? 700 : "100%", borderCollapse: "collapse" } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#f8f8f8" } }, ["Fundraiser", "Member Cost", "Club Profit", "Est. Sold", "Total Profit"].map((h, i) => /* @__PURE__ */ React.createElement("th", { key: h, style: { padding: isMobileTabs ? "8px 10px" : "9px 12px", fontSize: isMobileTabs ? 9 : 10, letterSpacing: 1, textTransform: "uppercase", color: "#999", fontWeight: 600, textAlign: i === 0 ? "left" : "right", borderBottom: "1px solid #eee" } }, h)))), /* @__PURE__ */ React.createElement("tbody", null, fundraisers.map((f) => /* @__PURE__ */ React.createElement("tr", { key: f.id, style: { borderBottom: "1px solid #f0f0f0" } }, /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 12px", fontSize: isMobileTabs ? 12 : 13, fontWeight: 600, color: FUND_BG } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 7 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 10, height: 10, borderRadius: "50%", background: FUND_ACCENT, flexShrink: 0 } }), f.name)), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 12px", textAlign: "right", fontSize: isMobileTabs ? 12 : 13, color: f.cost > 0 ? "#444" : "#bbb" } }, f.cost > 0 ? fmt(f.cost) : "\u2014"), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 12px", textAlign: "right", fontSize: isMobileTabs ? 12 : 13, color: "#444" } }, fmt(f.profit)), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 12px", textAlign: "right", fontSize: isMobileTabs ? 12 : 13, color: "#444" } }, f.estSold), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "9px 10px" : "10px 12px", textAlign: "right", fontSize: isMobileTabs ? 12.5 : 13.5, fontWeight: 700, color: FUND_ACCENT } }, fmt(f.profit * f.estSold))))), /* @__PURE__ */ React.createElement("tfoot", null, /* @__PURE__ */ React.createElement("tr", { style: { background: "#f4f5f7", borderTop: "2px solid #e0e0e0" } }, /* @__PURE__ */ React.createElement("td", { colSpan: 4, style: { padding: isMobileTabs ? "10px 10px" : "11px 12px", fontSize: isMobileTabs ? 12 : 13, fontWeight: 700, color: "#1a1a1a" } }, "Total Fundraiser Profit"), /* @__PURE__ */ React.createElement("td", { style: { padding: isMobileTabs ? "10px 10px" : "11px 12px", textAlign: "right", fontSize: isMobileTabs ? 14 : 15, fontWeight: 700, color: FUND_BG } }, fmt(totals.fundraiserProfit))))))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, letterSpacing: 1.5, textTransform: "uppercase", color: "#999", fontWeight: 600 } }, "Manage Fundraisers"), /* @__PURE__ */ React.createElement("button", { onClick: addFundraiser, style: { background: FUND_BG, color: "#fff", border: "none", borderRadius: 6, padding: "6px 14px", fontSize: 12, fontWeight: 600, cursor: "pointer" } }, "+ Add Fundraiser")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 14 } }, fundraisers.map((f) => {
